---
title: "前端指南"
description: "路由、布局、响应式、无障碍与交互方式。"
sidebar:
  order: 1
---
...
- 后端已在本机运行。环境搭建见 [开发指南](/zh/picumet/dev/development/)。
...
- [系统架构](/zh/picumet/dev/architecture/)：后端服务与共享类型。
- [API 参考](/zh/picumet/api/api/)：界面调用的 HTTP 接口。
- [开发指南](/zh/picumet/dev/development/)：本地环境、测试与规范。
- [部署指南](/zh/picumet/dev/deployment/)：发布到 Cloudflare。
- [进度报告](/picumet/about/progress/)：实现状态与路线图。
- [项目概览](../README_CN.md)
